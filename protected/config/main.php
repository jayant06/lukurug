...
return array(
	...
	'components'=>array(
		...
		'db'=>array(				
			'connectionString' => 'mysql:host=localhost;dbname=gurukul',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => 'qaz#123',
			//'password' => '',
		...
		'urlManager'=>array(
			...
			'rules'=>array(				
				...
				'admin/courses/index'=>'admin/categories/index',
				'admin/courses/create'=>'admin/categories/create',
				'admin/courses/update'=>'admin/categories/update',
				'admin/courses/delete'=>'admin/categories/delete',
				'admin'=>'admin',
